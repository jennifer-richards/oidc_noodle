"""
Django settings for oidc_noodle project.
...
SECRET_KEY = "django-insecure-#@=#aywe-s)u15-dk&v377mh$+6$ccm_b@bdt%h)br#l&r9&xz"
...
# mozilla-django-oidc auth backend
...
WSGI_APPLICATION = "oidc_noodle.wsgi.application"
